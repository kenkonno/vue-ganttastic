import j from "dayjs";
import { inject as ut, computed as R, defineComponent as N, openBlock as E, createElementBlock as O, createElementVNode as G, Fragment as z, renderList as W, unref as B, normalizeStyle as S, renderSlot as A, createTextVNode as lt, toDisplayString as Q, createCommentVNode as F, toRefs as nt, ref as Y, watch as ct, nextTick as Lt, createBlock as K, Teleport as Qt, createVNode as Bt, Transition as Zt, withCtx as tt, getCurrentScope as Jt, onScopeDispose as te, getCurrentInstance as ee, onMounted as St, useSlots as ne, provide as st, withModifiers as oe, mergeProps as Gt, TransitionGroup as ae } from "vue";
...
const ue = { class: "g-timeaxis" }, ce = ["onClick"], de = /* @__PURE__ */ G("p", { class: "milestone-description milestone-description-mark" }, "\u25BC", -1), fe = ["onClick"], ge = /* @__PURE__ */ N({
...
const he = /* @__PURE__ */ N({
  ...
  setup(t) {
    const r = t, o = {
      ...
      week: "DD. MMM HH:mm",
      month: "DD. MMMM YYYY"
    }, u = "cadetblue", { bar: s } = nt(r), { precision: c, font: f, barStart: g, barEnd: p, rowHeight: n } = I(), e = Y("0px"), i = Y("0px");
    ct(
      () => r.bar,
      async () => {
        var m;
...
function Ce(t, r = { width: 0, height: 0 }, o = {}) {
  const u = Y(r.width), s = Y(r.height);
  return Ee(t, ([c]) => {
...
function Mt(t, r = () => null, o = () => null, u = I()) {
  const { barStart: s, barEnd: c, pushOnOverlap: f } = u, g = Y(!1);
  let p = 0, n;
...
const ze = ["id"], Ne = { class: "g-gantt-bar-label" }, Ve = { style: { "z-index": "100" } }, qe = /* @__PURE__ */ G("div", { class: "g-gantt-bar-handle-left" }, null, -1), We = /* @__PURE__ */ G("div", { class: "g-gantt-bar-handle-right" }, null, -1), Xe = /* @__PURE__ */ N({
  __name: "GGanttBar",
  props: {
    bar: null
  },
  setup(t) {
    const r = t, o = Nt(), u = I(), { rowHeight: s } = u, { bar: c } = nt(r), { mapTimeToPosition: f, mapPositionToTime: g } = et(), { initDragOfBar: p, initDragOfBundle: n } = Fe(), { setDragLimitsOfGanttBar: e } = je(), i = Y(!1), l = R(() => c.value.ganttBarConfig);
    function w(k) {
    ...
    const C = () => {
      ...
      o(k, c.value, M);
    }, { barStart: x, barEnd: _, width: d, chartStart: b, chartEnd: a, chartSize: m } = u, v = Y(0), D = Y(0);
    return St(() => {
      ct(
        [c, d, b, a, m.width],
        () => {
...
const Ke = /* @__PURE__ */ N({
  ...
  emits: ["drop"],
  setup(t, { emit: r }) {
    const o = t, { rowHeight: u, colors: s } = I(), { highlightOnHover: c } = nt(o), f = Y(!1), g = R(() => ({
      height: `${u.value}px`,
      background: (c == null ? void 0 : c.value) && f.value ? s.value.hoverHighlight : null
    })), { mapPositionToTime: p } = et(), n = Y(null);
    st(Ut, n);
    const e = (i) => {
      var h;

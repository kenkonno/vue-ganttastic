  ...
  (function(n, u) {
    ...
    return function(n, u, s) {
      u.prototype.isBetween = function(c, d, g, f) {
        var r = s(c), e = s(d), o = (f = f || "()")[0] === "(", l = f[1] === ")";
        return (o ? this.isAfter(r, g) : !this.isBefore(r, g)) && (l ? this.isBefore(e, g) : !this.isAfter(e, g)) || (o ? this.isBefore(r, g) : !this.isAfter(r, g)) && (l ? this.isAfter(e, g) : !this.isBefore(e, g));
      };
    };
  });
})(Yt);
...
function nt(t = A()) {
  const { chartStart: a, chartEnd: n, barStart: u, barEnd: s, dateFormat: c } = t, d = I(() => f(a.value)), g = I(() => f(n.value)), f = (e, o) => {
    let l;
...
function xt() {
  const { precision: t } = A(), { chartStartDayjs: a, chartEndDayjs: n } = nt(), u = I(() => {
  ...
  return {
    timeaxisUnits: I(() => {
      const d = [], g = [], f = u.value === "day" ? "date" : u.value, r = t.value;
      ...
      for (; e.isBefore(n.value) || e.isSame(n.value); ) {
        ...
        const x = e;
        e = e.add(1, r), (e.isBefore(n.value) || e.isSame(n.value)) && (l += e.diff(x, "minutes", !0));
      }
...
const ue = { class: "g-timeaxis" }, ce = { class: "g-timeunits-container" }, de = { class: "g-timeunits-container" }, fe = /* @__PURE__ */ V({
  ...
  setup(t) {
    const { precision: a, colors: n } = A(), { timeaxisUnits: u } = xt();
    return (s, c) => (k(), T("div", ue, [
      Y("div", ce, [
        (k(!0), T(X, null, tt(E(u).upperUnits, ({ label: d, value: g, date: f, width: r }, e) => (k(), T("div", {
          key: d,
      ...
      Y("div", de, [
        (k(!0), T(X, null, tt(E(u).lowerUnits, ({ label: d, value: g, date: f, width: r }, e) => (k(), T("div", {
          key: d,
          class: "g-timeunit",
          style: R({
...
const ge = { class: "g-grid-container" }, he = /* @__PURE__ */ V({
  ...
  setup(t) {
    ...
    return (u, s) => (k(), T("div", ge, [
      (k(!0), T(X, null, tt(E(n).lowerUnits, ({ label: c, value: d, width: g }) => {
        var f;
        return k(), T("div", {
          key: c,
          class: "g-grid-line",
...
const pe = /* @__PURE__ */ V({
  ...
  setup(t) {
    const a = t, n = {
      ...
      day: "DD. MMM HH:mm",
      month: "DD. MMMM YYYY"
    }, u = "cadetblue", { bar: s } = et(a), { precision: c, font: d, barStart: g, barEnd: f, rowHeight: r } = A(), e = $("0px"), o = $("0px");
    ut(
      () => a.bar,
      async () => {
        var m;
...
var Dt = Object.getOwnPropertySymbols, Be = Object.prototype.hasOwnProperty, _e = Object.prototype.propertyIsEnumerable, Ee = (t, a) => {
  var n = {};
  for (var u in t)
    Be.call(t, u) && a.indexOf(u) < 0 && (n[u] = t[u]);
  if (t != null && Dt)
    for (var u of Dt(t))
      a.indexOf(u) < 0 && _e.call(t, u) && (n[u] = t[u]);
  return n;
};
function Oe(t, a, n = {}) {
...
function De(t, a = { width: 0, height: 0 }, n = {}) {
  ...
  return Oe(t, ([c]) => {
    ...
    u.value = c ? a.width : 0, s.value = c ? a.height : 0;
  }), {
    width: u,
    height: s
  };
...
const Ye = (t, a) => {
  ...
  setup(t, { emit: a }) {
    const n = t, { width: u, font: s, colorScheme: c } = et(n), d = ee(), g = I(
    ...
    return it(Rt, f), it(At, {
      ...
      Y("div", Ae, [
        ...
        Y("div", {
          ...
          ref: b,
          class: "g-gantt-chart",
          style: R({ width: E(u), background: E(g).background, fontFamily: E(s) })
        }, [
          t.hideTimeaxis ? j("", !0) : (k(), J(fe, { key: 0 }, {
...
function Bt(t = A()) {
  const { dateFormat: a, chartSize: n } = t, { chartStartDayjs: u, chartEndDayjs: s, toDayjs: c, format: d } = nt(t), g = I(() => s.value.diff(u.value, "minutes"));
  return {
    mapTimeToPosition: (e) => {
    ...
    mapPositionToTime: (e) => {
      const o = n.width.value || 0, l = e / o * g.value, w = d(u.value.add(l, "minutes"), a.value);
      if (typeof w == "string")
        return w;
      throw Error;
    }
...
function Mt(t, a = () => null, n = () => null, u = A()) {
  const { barStart: s, barEnd: c, pushOnOverlap: d } = u, g = $(!1);
  let f = 0, r;
  const { mapPositionToTime: e } = Bt(u), { toDayjs: o } = nt(u), l = (p) => {
...
function Fe() {
  const t = A(), a = Pt(), n = zt(), { pushOnOverlap: u, barStart: s, barEnd: c, noOverlap: d, dateFormat: g } = t, f = /* @__PURE__ */ new Map(), { toDayjs: r, format: e } = nt(), o = (i, m) => {
...
function je() {
  const { pushOnOverlap: t } = A(), a = Pt(), n = (d) => {
    ...
    for (const f of ["left", "right"]) {
      ...
      l != null && r === "left" ? d.ganttBarConfig.dragLimitLeft = D.offsetLeft - l : l != null && r === "right" && (d.ganttBarConfig.dragLimitRight = D.offsetLeft + D.offsetWidth + l);
    }
    ...
    if (f === "left")
      for (; o; ) {
        const l = document.getElementById(e.ganttBarConfig.id), w = document.getElementById(o.ganttBarConfig.id), D = w.offsetLeft + w.offsetWidth;
    ...
    if (f === "right")
      for (; o; ) {
        const l = document.getElementById(e.ganttBarConfig.id), w = document.getElementById(o.ganttBarConfig.id), D = l.offsetLeft + l.offsetWidth;
    ...
    return g === "left" ? e = r.filter((o) => {
      ...
      return l && l.offsetLeft < f.offsetLeft && o.ganttBarConfig.pushOnOverlap !== !1;
    }) : e = r.filter((o) => {
      const l = document.getElementById(o.ganttBarConfig.id);
      return l && l.offsetLeft > f.offsetLeft && o.ganttBarConfig.pushOnOverlap !== !1;
    }), e.length > 0 ? e.reduce((o, l) => {
      const w = document.getElementById(o.ganttBarConfig.id), D = document.getElementById(l.ganttBarConfig.id), v = Math.abs(w.offsetLeft - f.offsetLeft), b = Math.abs(D.offsetLeft - f.offsetLeft);
      return v < b ? o : l;
    }, e[0]) : null;
  };
  return {
...
const Pe = ["id"], ze = { class: "g-gantt-bar-label" }, Ne = { style: { "z-index": "100" } }, Ve = /* @__PURE__ */ Y("div", { class: "g-gantt-bar-handle-left" }, null, -1), qe = /* @__PURE__ */ Y("div", { class: "g-gantt-bar-handle-right" }, null, -1), We = /* @__PURE__ */ V({
  ...
  setup(t) {
    const a = t, n = zt(), u = A(), { rowHeight: s } = u, { bar: c } = et(a), { mapTimeToPosition: d, mapPositionToTime: g } = Bt(), { initDragOfBar: f, initDragOfBundle: r } = Fe(), { setDragLimitsOfGanttBar: e } = je(), o = $(!1), l = I(() => c.value.ganttBarConfig);
    function w(O) {
      l.value.bundle != null ? r(c.value, O) : f(c.value, O), o.value = !0;
    }
    const D = () => {
    ...
    return Lt(() => {
      ...
      Y("div", ze, [
        F(O.$slots, "default", { bar: E(c) }, () => [
          Y("div", Ne, Z(E(l).label || ""), 1),
          E(l).progress ? (k(), T("div", {
            key: 0,
            style: R([{ position: "absolute", height: "100%", left: "0" }, {
              width: E(l).progress + "%",
              backgroundColor: E(l).progressColor
            }])
          }, Z(E(l).progress), 5)) : j("", !0)
        ])
      ]),
      E(l).hasHandles ? (k(), T(X, { key: 0 }, [
        Ve,
        qe
      ], 64)) : j("", !0)
    ], 44, Pe));
...
const Ke = /* @__PURE__ */ V({
  ...
  emits: ["drop"],
  setup(t, { emit: a }) {
    const n = t, { rowHeight: u, colors: s } = A(), { highlightOnHover: c } = et(n), d = $(!1), g = I(() => ({
      height: `${u.value}px`,
    ...
    const e = (o) => {
      var v;
      const l = (v = r.value) == null ? void 0 : v.getBoundingClientRect();
      if (!l) {
        console.error("Vue-Ganttastic: failed to find bar container element for row.");
        return;
      }
      const w = o.clientX - l.left, D = f(w);
    ...
    return (o, l) => (k(), T("div", {
      ...
      Y("div", re({
        ...
        wt(ae, {
          ...
          default: Q(() => [
            (k(!0), T(X, null, tt(t.bars, (w) => (k(), J(We, {
...
function q(t, a = "top") {
  ...
  a === "top" && n.firstChild ? n.insertBefore(u, n.firstChild) : n.appendChild(u), u.appendChild(document.createTextNode(t));
}
q(`
.g-gantt-row {
  width: 100%;

...
const je = ["id"], Ue = { class: "g-gantt-bar-label" }, ze = { style: { "z-index": "100" } }, Ne = /* @__PURE__ */ $("div", { class: "g-gantt-bar-handle-left" }, null, -1), Ve = /* @__PURE__ */ $("div", { class: "g-gantt-bar-handle-right" }, null, -1), qe = /* @__PURE__ */ U({
  ...
  setup(t) {
    const r = t, n = Nt(), l = A(), { rowHeight: i } = l, { bar: u } = et(r), { mapTimeToPosition: f, mapPositionToTime: g } = ft(), { initDragOfBar: c, initDragOfBundle: a } = Fe(), { setDragLimitsOfGanttBar: e } = Pe(), o = Y(!1), d = I(() => u.value.ganttBarConfig);
    function w(D) {
...
const Ke = /* @__PURE__ */ U({
  ...
  setup(t) {
    const { rowHeight: r, colors: n } = A(), { timeaxisUnits: l } = dt();
    return (i, u) => (O(), M("div", {
      class: "g-gantt-row",

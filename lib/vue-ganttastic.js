  ...
  (function(n, l) {
    ...
    function D(v) {
      ...
      for (var h = (v = b.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, function(O, k, S) {
        ...
        return k || x[S] || n[S] || x[M].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, function(G, Y, F) {
          return Y || F.slice(1);
        });
      ...
      return function(O) {
        for (var k = {}, S = 0, M = 0; S < p; S += 1) {
          ...
          if (typeof G == "string")
            ...
            var Y = G.regex, F = G.parser, U = O.slice(M), K = Y.exec(U)[0];
    ...
    return function(v, b, x) {
      ...
      h.parse = function(B) {
        ...
        if (typeof E == "string") {
          ...
          for (var G = E.length, Y = 1; Y <= G; Y += 1) {
            y[1] = E[Y - 1];
...
const Re = (t, r) => {
  ...
  for (const [l, s] of r)
    n[l] = s;
  return n;
}, Ye = /* @__PURE__ */ Re($e, [["__scopeId", "data-v-400629df"]]), Ie = { style: { display: "flex" } }, Ae = { class: "g-gantt-rows-container" }, He = /* @__PURE__ */ N({
  __name: "GGanttChart",
  props: {
    chartStart: null,
    chartEnd: null,
...
function Fe() {
  const t = I(), r = zt(), n = Nt(), { pushOnOverlap: l, barStart: s, barEnd: d, noOverlap: u, dateFormat: g } = t, f = /* @__PURE__ */ new Map(), { toDayjs: a, format: e } = nt(), o = (i, m) => {
    ...
    for (; y; ) {
      ...
      switch (E) {
        case "left":
          G = M.diff(O, "minutes", !0), y[d.value] = e(m[s.value], g.value), y[s.value] = e(
            S.subtract(G, "minutes"),
            g.value
          );
          break;
        case "right":
          G = k.diff(S, "minutes", !0), y[s.value] = e(k, g.value), y[d.value] = e(
            M.add(G, "minutes"),
            g.value
          );
          break;
      ...
      y && (E === "left" || E === "right") && b(y, G, E), m = y, { overlapBar: y, overlapType: E } = v(y);
    }
  }, v = (i) => {
    let m, y, E;
...
const Pe = ["id"], Ue = { class: "g-gantt-bar-label" }, ze = { style: { "z-index": "100" } }, Ne = /* @__PURE__ */ L("div", { class: "g-gantt-bar-handle-left" }, null, -1), Ve = /* @__PURE__ */ L("div", { class: "g-gantt-bar-handle-right" }, null, -1), qe = /* @__PURE__ */ N({
  __name: "GGanttBar",
  props: {
    bar: null
  },
  setup(t) {
    const r = t, n = Nt(), l = I(), { rowHeight: s } = l, { bar: d } = et(r), { mapTimeToPosition: u, mapPositionToTime: g } = Bt(), { initDragOfBar: f, initDragOfBundle: a } = Fe(), { setDragLimitsOfGanttBar: e } = je(), o = $(!1), c = H(() => d.value.ganttBarConfig);
    function w(O) {
    ...
    return (o, c) => (C(), T("div", {
      ...
      L("div", Gt({
        ...
        xt(re, {
          ...
          default: X(() => [
            (C(!0), T(z, null, Z(t.bars, (w) => (C(), tt(qe, {

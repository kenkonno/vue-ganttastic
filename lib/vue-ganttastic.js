...
function ot(t = I()) {
  ...
  return {
    ...
    chartEndDayjs: g,
    toDayjs: p,
    format: (e, i) => i === !1 ? e instanceof Date ? e : F(e).toDate() : (typeof e == "string" || e instanceof Date ? p(e) : e).format(i)
  };
}
function ft() {
...
const ue = { class: "g-timeaxis" }, ce = ["onClick"], de = ["onClick"], fe = { class: "milestone-description milestone-description-mark" }, ge = /* @__PURE__ */ N({
  ...
  setup(t, { emit: r }) {
    ...
    }, { mapTimeToPosition: g } = et(), p = (n) => g(F(n).startOf("day").format("DD.MM.YYYY HH:mm"));
    return (n, e) => {
      var i;
      return E(), O("div", ue, [
        Y("div", {
...
const Re = (t, r) => {
  ...
  setup(t, { emit: r }) {
    const { mapTimeToPosition: o } = et(), u = R(() => (r("today-line-position-x", { xPosition: o(F().startOf("day").format("DD.MM.YYYY HH:mm")) }), o(F().startOf("day").format("DD.MM.YYYY HH:mm"))));
    return (s, c) => (E(), O("div", {
      class: "vertical-line",
...
function Mt(t, r = () => null, o = () => null, u = I()) {
  ...
  const { mapPositionToTime: e } = et(u), { toDayjs: i } = ot(u), l = (d) => {
    ...
    if (!b || !a)
      return;
    const m = d.clientX - a.left, v = e(m);
    i(v).isSameOrBefore(i(t, "start")) || (t[c.value] = e(m).substring(0, 10) + " 23:59", r(d, t));
  }, x = (d, b) => {
    if (!f.value)
      return !1;
...
const ze = ["id"], Ne = { class: "g-gantt-bar-label" }, Ve = { style: { "z-index": "100" } }, qe = /* @__PURE__ */ Y("div", { class: "g-gantt-bar-handle-left" }, null, -1), We = /* @__PURE__ */ Y("div", { class: "g-gantt-bar-handle-right" }, null, -1), Xe = /* @__PURE__ */ N({
  ...
  setup(t) {
    const r = t, o = Nt(), u = I(), { rowHeight: s } = u, { bar: c } = nt(r), { mapTimeToPosition: f, mapPositionToTime: g } = et(), { initDragOfBar: p, initDragOfBundle: n } = je(), { setDragLimitsOfGanttBar: e } = Fe(), i = G(!1), l = R(() => c.value.ganttBarConfig);
    function w(k) {
...
function Ze() {
  F.extend(re), F.extend(ie), F.extend(se), F.extend(le);
}
const nn = {
  install(t, r) {

...
(function(t, o) {
  (function(n, l) {
    ...
    return function(n, l, s) {
      l.prototype.isBetween = function(u, c, g, d) {
        var a = s(u), e = s(c), r = (d = d || "()")[0] === "(", f = d[1] === ")";
        return (r ? this.isAfter(a, g) : !this.isBefore(a, g)) && (f ? this.isBefore(e, g) : !this.isAfter(e, g)) || (r ? this.isBefore(a, g) : !this.isAfter(a, g)) && (f ? this.isAfter(e, g) : !this.isBefore(e, g));
      };
    };
  });
})(Yt);
...
(function(t, o) {
  (function(n, l) {
    ...
    var n = { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" }, l = /(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, s = /\d\d/, u = /\d\d?/, c = /\d*[^-_:/,()\s\d]+/, g = {}, d = function(v) {
...
function nt(t = A()) {
  const { chartStart: o, chartEnd: n, barStart: l, barEnd: s, dateFormat: u } = t, c = I(() => d(o.value)), g = I(() => d(n.value)), d = (e, r) => {
    let f;
    if (r !== void 0 && typeof e != "string" && !(e instanceof Date) && (f = r === "start" ? e[l.value] : e[s.value]), typeof e == "string")
      f = e;
  ...
  return {
    ...
    chartEndDayjs: g,
    toDayjs: d,
    format: (e, r) => r === !1 ? e instanceof Date ? e : W(e).toDate() : (typeof e == "string" || e instanceof Date ? d(e) : e).format(r)
  };
}
function dt() {
  ...
  return {
    timeaxisUnits: I(() => {
      const c = [], g = [], d = l.value === "day" ? "date" : l.value, a = t.value;
      ...
      for (; e.isBefore(n.value) || e.isSame(n.value); ) {
        if (e[d]() !== w) {
          let h = 0;
          if (c.length === 0)
            h = e.startOf(d).diff(o.value, "minutes", !0) / r * 100;
            ...
            const i = e.startOf(d), p = e.subtract(1, d).startOf(d);
            h = i.diff(p, "minutes", !0) / r * 100;
          }
          const B = e.subtract(1, d);
          c.push({
            label: B.format(s[d]),
            value: String(w),
            date: B.toDate(),
        ...
        const m = e;
        e = e.add(1, a), (e.isBefore(n.value) || e.isSame(n.value)) && (f += e.diff(m, "minutes", !0));
      }
      const D = n.value.isSame(n.value.startOf(d)) ? n.value[d]() - 1 : n.value[d]();
      return c.some((b) => b.value === String(D)) || (f += n.value.diff(
        e.subtract(1, a),
        "minutes",
        !0
      ), c.push({
...
const ue = { class: "g-timeaxis" }, ce = { class: "g-timeunits-container" }, de = { class: "g-timeunits-container" }, fe = /* @__PURE__ */ N({
  ...
  setup(t) {
    ...
    return (s, u) => (C(), M("div", ue, [
      G("div", ce, [
        (C(!0), M(z, null, Z(_(l).upperUnits, ({ label: c, value: g, date: d, width: a }, e) => (C(), M("div", {
          key: d.getTime(),
      ...
      G("div", de, [
        (C(!0), M(z, null, Z(_(l).lowerUnits, ({ label: c, value: g, date: d, width: a }, e) => (C(), M("div", {
          key: c,
          class: "g-timeunit",
          style: R({
...
const ge = { class: "g-grid-container" }, he = /* @__PURE__ */ N({
  ...
  setup(t) {
    ...
    return (u, c) => (C(), M("div", ge, [
      (C(!0), M(z, null, Z(_(s).lowerUnits, ({ label: g, value: d, width: a, date: e }) => {
        var r;
        return C(), M("div", {
          key: e.getTime(),
          class: "g-grid-line",
...
const pe = /* @__PURE__ */ N({
  ...
  setup(t) {
    const o = t, n = {
      ...
      week: "DD. MMM HH:mm",
      month: "DD. MMMM YYYY"
    }, l = "cadetblue", { bar: s } = et(o), { precision: u, font: c, barStart: g, barEnd: d, rowHeight: a } = A(), e = $("0px"), r = $("0px");
    ut(
      () => o.bar,
      async () => {
        var p;
...
function Oe(t, o, n = {}) {
  ...
  let c;
  const g = xe(() => s && "ResizeObserver" in s), d = () => {
    c && (c.disconnect(), c = void 0);
  }, a = ut(() => Ut(t), (r) => {
    d(), g.value && s && r && (c = new ResizeObserver(o), c.observe(r, u));
...
function Bt(t = A()) {
  ...
  return {
    mapTimeToPosition: (e) => {
      const r = n.width.value || 0, f = u(e).diff(l.value, "minutes", !0);
      return Math.ceil(f / g.value * r);
    },
    mapPositionToTime: (e) => {
      const r = n.width.value || 0, f = e / r * g.value, w = c(l.value.add(f, "minutes"), o.value);
      if (typeof w == "string")
        return w;
      throw Error;
    }
...
function Mt(t, o = () => null, n = () => null, l = A()) {
  ...
  let d = 0, a;
  const { mapPositionToTime: e } = Bt(l), { toDayjs: r } = nt(l), f = (h) => {
    const B = document.getElementById(t.ganttBarConfig.id);
    if (!B)
      return;
    switch (d = h.clientX - (B.getBoundingClientRect().left || 0), h.target.className) {
    ...
    if (!B || !i)
      return;
    const p = B.getBoundingClientRect().width, y = h.clientX - i.left - d, E = y + p;
    if (!x(y, E)) {
...
function He() {
  const t = A(), o = zt(), n = Nt(), { pushOnOverlap: l, barStart: s, barEnd: u, noOverlap: c, dateFormat: g } = t, d = /* @__PURE__ */ new Map(), { toDayjs: a, format: e } = nt(), r = (i, p) => {
    ...
    n(y, p, void 0, new Map(d)), d.clear();
  }, h = (i) => {
    if (!d.has(i)) {
      const p = i[s.value], y = i[u.value];
      d.set(i, { oldStart: p, oldEnd: y });
    }
  }, B = () => {
    if (l.value || !c.value)
      return;
    ...
    d.forEach((p, y) => {
      ...
      E != null && (i = !0);
    }), i && d.forEach(({ oldStart: p, oldEnd: y }, E) => {
...
function Fe() {
  const { pushOnOverlap: t } = A(), o = zt(), n = (c) => {
    ...
    for (const d of ["left", "right"]) {
      ...
      for (let v = 0; v < w.length; v++) {
        ...
        n(b.ganttBarConfig.bundle).filter(
          ...
          i != null && (!f || i < f) && (f = i), p.forEach((y) => {
            w.find((E) => E.bar === y.bar) || w.push(y);
          });
        });
      }
      const D = document.getElementById(c.ganttBarConfig.id);
      f != null && a === "left" ? c.ganttBarConfig.dragLimitLeft = D.offsetLeft - f : f != null && a === "right" && (c.ganttBarConfig.dragLimitRight = D.offsetLeft + D.offsetWidth + f);
    }
    ...
    if (d === "left")
      for (; r; ) {
        const f = document.getElementById(e.ganttBarConfig.id), w = document.getElementById(r.ganttBarConfig.id), D = w.offsetLeft + w.offsetWidth;
        if (g += f.offsetLeft - D, r.ganttBarConfig.immobile)
    ...
    if (d === "right")
      for (; r; ) {
        const f = document.getElementById(e.ganttBarConfig.id), w = document.getElementById(r.ganttBarConfig.id), D = f.offsetLeft + f.offsetWidth;
    ...
    const d = document.getElementById(c.ganttBarConfig.id), a = o().find((r) => r.includes(c)) || [];
    let e = [];
    return g === "left" ? e = a.filter((r) => {
      const f = document.getElementById(r.ganttBarConfig.id);
      return f && f.offsetLeft < d.offsetLeft && r.ganttBarConfig.pushOnOverlap !== !1;
    }) : e = a.filter((r) => {
      const f = document.getElementById(r.ganttBarConfig.id);
      return f && f.offsetLeft > d.offsetLeft && r.ganttBarConfig.pushOnOverlap !== !1;
    }), e.length > 0 ? e.reduce((r, f) => {
      const w = document.getElementById(r.ganttBarConfig.id), D = document.getElementById(f.ganttBarConfig.id), v = Math.abs(w.offsetLeft - d.offsetLeft), b = Math.abs(D.offsetLeft - d.offsetLeft);
      return v < b ? r : f;
    }, e[0]) : null;
  };
  return {
...
const je = ["id"], Pe = { class: "g-gantt-bar-label" }, Ue = { style: { "z-index": "100" } }, ze = /* @__PURE__ */ G("div", { class: "g-gantt-bar-handle-left" }, null, -1), Ne = /* @__PURE__ */ G("div", { class: "g-gantt-bar-handle-right" }, null, -1), Ve = /* @__PURE__ */ N({
  ...
  setup(t) {
    const o = t, n = Nt(), l = A(), { rowHeight: s } = l, { bar: u } = et(o), { mapTimeToPosition: c, mapPositionToTime: g } = Bt(), { initDragOfBar: d, initDragOfBundle: a } = He(), { setDragLimitsOfGanttBar: e } = Fe(), r = $(!1), f = I(() => u.value.ganttBarConfig);
    function w(O) {
      f.value.bundle != null ? a(u.value, O) : d(u.value, O), r.value = !0;
    }
    const D = () => {
      e(u.value), !f.value.immobile && (window.addEventListener("mousemove", w, {
        once: !0
    ...
    return Lt(() => {
      ...
      G("div", Pe, [
        H(O.$slots, "default", { bar: _(u) }, () => [
          G("div", Ue, J(_(f).label || ""), 1),
          _(f).progress ? (C(), M("div", {
            key: 0,
            style: R([{ position: "absolute", height: "100%", left: "0" }, {
              width: _(f).progress + "%",
              backgroundColor: _(f).progressColor
            }])
          }, null, 4)) : P("", !0)
        ])
      ]),
      _(f).hasHandles ? (C(), M(z, { key: 0 }, [
        ze,
        Ne
      ], 64)) : P("", !0)
    ], 44, je));
...
const qe = /* @__PURE__ */ N({
  ...
  setup(t, { emit: o }) {
    ...
    const e = (r) => {
      var v;
      const f = (v = a.value) == null ? void 0 : v.getBoundingClientRect();
      if (!f) {
        console.error("Vue-Ganttastic: failed to find bar container element for row.");
        return;
      }
      const w = r.clientX - f.left, D = d(w);
      o("drop", { e: r, datetime: D });
    };
    return (r, f) => (C(), M("div", {
      class: "g-gantt-row",
      style: R(_(g)),
      onDragover: f[0] || (f[0] = ae((w) => c.value = !0, ["prevent"])),
      onDragleave: f[1] || (f[1] = (w) => c.value = !1),
      onDrop: f[2] || (f[2] = (w) => e(w)),
      onMouseover: f[3] || (f[3] = (w) => c.value = !0),
      onMouseleave: f[4] || (f[4] = (w) => c.value = !1)
    }, [
      P("", !0),
      G("div", Gt({
  ...
  setup(t) {
    ...
    return (s, u) => (C(), M("div", {
      ...
      G("div", Gt({
        ...
        (C(!0), M(z, null, Z(_(l).lowerUnits, ({ label: c, width: g }, d) => (C(), M("div", {
          key: c,
          class: "g-timeunit",
          style: R({
            color: _(n).text,
          ...
          G("span", {
            style: R(t.styles != null ? t.styles[d] : void 0)
          }, J(t.labels[d]), 5)
        ], 4))), 128))
      ], 16)
    ], 4));

import V from "dayjs";
import { inject as ut, computed as I, defineComponent as U, openBlock as O, createElementBlock as M, createElementVNode as $, Fragment as q, renderList as Z, unref as _, normalizeStyle as L, renderSlot as H, createTextVNode as st, toDisplayString as J, createCommentVNode as j, toRefs as et, ref as Y, watch as ct, nextTick as St, createBlock as tt, Teleport as Xt, createVNode as lt, Transition as Zt, withCtx as X, getCurrentScope as Jt, onScopeDispose as te, getCurrentInstance as ee, onMounted as Lt, useSlots as ne, provide as it, withModifiers as ae, mergeProps as Gt, TransitionGroup as re } from "vue";
var dt = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, $t = { exports: {} };
(function(t, r) {
  (function(n, l) {
    t.exports = l();
  })(dt, function() {
        ...
        if (typeof E == "string") {
          ...
          k && (S = y[2]), g = this.$locale(), !D && S && (g = x.Ls[S]), this.$d = function(N, K, W) {
            try {
              ...
              var P = C(K)(N), Q = P.year, rt = P.month, Vt = P.day, qt = P.hours, Wt = P.minutes, Kt = P.seconds, Qt = P.milliseconds, _t = P.zone, ht = new Date(), pt = Vt || (Q || rt ? 1 : ht.getDate()), mt = Q || ht.getFullYear(), ot = 0;
              Q && !rt || (ot = rt > 0 ? rt - 1 : ht.getMonth());
              var vt = qt || 0, yt = Wt || 0, bt = Kt || 0, wt = Qt || 0;
              return _t ? new Date(Date.UTC(mt, ot, pt, vt, yt, bt, wt + 60 * _t.offset * 1e3)) : W ? new Date(Date.UTC(mt, ot, pt, vt, yt, bt, wt)) : new Date(mt, ot, pt, vt, yt, bt, wt);
            } catch {
              return new Date("");
            }
...
const le = It.exports, At = Symbol("CHART_ROWS_KEY"), Ht = Symbol("CONFIG_KEY"), Ft = Symbol("EMIT_BAR_EVENT_KEY"), Pt = Symbol("BAR_CONTAINER_KEY");
function A() {
  const t = ut(Ht);
  if (!t)
...
const ue = { class: "g-timeaxis" }, ce = { class: "g-timeunits-container" }, de = { class: "g-timeunits-container" }, fe = /* @__PURE__ */ U({
  ...
  setup(t) {
    const { precision: r, colors: n } = A(), { timeaxisUnits: l } = ft();
    return (i, u) => (O(), M("div", ue, [
      $("div", ce, [
        (O(!0), M(q, null, Z(_(l).upperUnits, ({ label: f, value: g, date: c, width: a }, e) => (O(), M("div", {
          key: c.getTime(),
      ...
      $("div", de, [
        (O(!0), M(q, null, Z(_(l).lowerUnits, ({ label: f, value: g, date: c, width: a }, e) => (O(), M("div", {
          key: c.getTime(),
          class: "g-timeunit",
          style: L({
...
const ge = { class: "g-grid-container" }, he = /* @__PURE__ */ U({
  ...
  setup(t) {
    ...
    }), { colors: l } = A(), { timeaxisUnits: i } = ft();
    return (u, f) => (O(), M("div", ge, [
      (O(!0), M(q, null, Z(_(i).lowerUnits, ({ label: g, value: c, width: a, date: e }) => {
        var o;
        return O(), M("div", {
          key: e.getTime(),
          class: "g-grid-line",
...
const pe = /* @__PURE__ */ U({
  ...
  setup(t) {
    const r = t, n = {
      ...
      week: "DD. MMM HH:mm",
      month: "DD. MMMM YYYY"
    }, l = "cadetblue", { bar: i } = et(r), { precision: u, font: f, barStart: g, barEnd: c, rowHeight: a } = A(), e = Y("0px"), o = Y("0px");
    ct(
      () => r.bar,
      async () => {
        var p;
...
const Ie = /* @__PURE__ */ U({
  __name: "GGanttDrawTodaysLine",
  setup(t) {
    const { mapTimeToPosition: r } = gt(), n = I(() => r(V().startOf("day").format("DD.MM.YYYY HH:mm")));
    return (l, i) => (O(), M("div", {
      class: "today-line",
      style: L({ left: _(n) + "px" })
    }, " TODAY LINE ", 4));
...
const Ae = { class: "g-gantt-rows-container" }, He = /* @__PURE__ */ U({
  __name: "GGanttChart",
  props: {
    chartStart: null,
    chartEnd: null,
  ...
  setup(t, { emit: r }) {
    ...
    return it(At, c), it(Ht, {
      ...
      $("div", {
        ...
        t.hideTimeaxis ? j("", !0) : (O(), tt(fe, { key: 0 }, {
          "upper-timeunit": X(({ label: B, value: s, date: p }) => [
          ...
          timeunit: X(({ label: B, value: s, date: p }) => [
            H(m.$slots, "timeunit", {
              label: B,
              value: s,
              date: p
...
function Mt(t, r = () => null, n = () => null, l = A()) {
  const { barStart: i, barEnd: u, pushOnOverlap: f } = l, g = Y(!1);
  let c = 0, a;
  const { mapPositionToTime: e } = gt(l), { toDayjs: o } = nt(l), d = (h) => {
...
function Fe() {
  const t = A(), r = zt(), n = Nt(), { pushOnOverlap: l, barStart: i, barEnd: u, noOverlap: f, dateFormat: g } = t, c = /* @__PURE__ */ new Map(), { toDayjs: a, format: e } = nt(), o = (s, p) => {
...
function Pe() {
  const { pushOnOverlap: t } = A(), r = zt(), n = (f) => {
    const g = [];
...
const je = ["id"], Ue = { class: "g-gantt-bar-label" }, ze = { style: { "z-index": "100" } }, Ne = /* @__PURE__ */ $("div", { class: "g-gantt-bar-handle-left" }, null, -1), Ve = /* @__PURE__ */ $("div", { class: "g-gantt-bar-handle-right" }, null, -1), qe = /* @__PURE__ */ U({
  ...
  setup(t) {
    const r = t, n = Nt(), l = A(), { rowHeight: i } = l, { bar: u } = et(r), { mapTimeToPosition: f, mapPositionToTime: g } = gt(), { initDragOfBar: c, initDragOfBundle: a } = Fe(), { setDragLimitsOfGanttBar: e } = Pe(), o = Y(!1), d = I(() => u.value.ganttBarConfig);
    function w(D) {
    ...
    return Lt(() => {
      ...
      $("div", Ue, [
        H(D.$slots, "default", { bar: _(u) }, () => [
          $("div", ze, J(_(d).label || ""), 1),
...
const We = /* @__PURE__ */ U({
  ...
  emits: ["drop"],
  setup(t, { emit: r }) {
    const n = t, { rowHeight: l, colors: i } = A(), { highlightOnHover: u } = et(n), f = Y(!1), g = I(() => ({
      height: `${l.value}px`,
      background: (u == null ? void 0 : u.value) && f.value ? i.value.hoverHighlight : null
    })), { mapPositionToTime: c } = gt(), a = Y(null);
    it(Pt, a);
    const e = (o) => {
      var v;
    ...
    return (o, d) => (O(), M("div", {
      ...
      $("div", Gt({
        ...
        lt(re, {
          ...
          default: X(() => [
            (O(!0), M(q, null, Z(t.bars, (w) => (O(), tt(qe, {
...
const Ke = /* @__PURE__ */ U({
  ...
  setup(t) {
    const { rowHeight: r, colors: n } = A(), { timeaxisUnits: l } = ft();
    return (i, u) => (O(), M("div", {
      class: "g-gantt-row",
      ...
      $("div", Gt({
        ...
        (O(!0), M(q, null, Z(_(l).lowerUnits, ({ label: f, width: g, date: c }, a) => (O(), M("div", {
          key: c.getTime(),
          class: "g-timeunit",
          style: L({
            color: _(n).text,
...
const tn = {
  install(t, r) {
    Qe(), t.component("GGanttChart", He), t.component("GGanttRow", We), t.component("GGanttLabelRow", Ke);
  }
};
function z(t, r = "top") {

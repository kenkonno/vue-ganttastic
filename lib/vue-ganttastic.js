        ...
        if (typeof D == "string") {
          ...
          T && (S = v[2]), h = this.$locale(), !k && S && (h = x.Ls[S]), this.$d = function(q, Q, W) {
            try {
              ...
              var F = C(Q)(q), Z = F.year, rt = F.month, Vt = F.day, qt = F.hours, Wt = F.minutes, Xt = F.seconds, Kt = F.milliseconds, _t = F.zone, gt = new Date(), mt = Vt || (Z || rt ? 1 : gt.getDate()), ht = Z || gt.getFullYear(), it = 0;
...
function dt() {
  ...
  return {
    timeaxisUnits: I(() => {
      ...
      const C = n.value.isSame(n.value.startOf(g)) ? n.value[g]() - 1 : n.value[g]();
      return m.some((y) => y.value === String(C)) || (c += n.value.diff(
        e.subtract(1, a),
        "minutes",
        !0
      ), m.push({
    ...
    return (e, o) => {
      ...
      return E(), O("div", ue, [
        G("div", {
          ...
          (E(!0), O(z, null, X(B(u).upperUnits, ({ label: b, value: C, date: f, width: y }, x) => (E(), O("div", {
            key: f.getTime(),
        ...
        G("div", {
          ...
          (E(!0), O(z, null, X(B(u).lowerUnits, ({ label: b, value: C, date: f, width: y }, x) => (E(), O("div", {
            key: f.getTime(),
            class: "g-timeunit",
            style: L({
        ...
        ((c = t.mileStoneList) == null ? void 0 : c.length) > 0 ? (E(), O("div", {
          key: 0,
          class: "g-timeunits-container",
          style: m
        }, [
...
const me = { class: "g-grid-container" }, he = /* @__PURE__ */ N({
  ...
  setup(t) {
    ...
    return (u, m) => (E(), O("div", me, [
      (E(!0), O(z, null, X(B(i).lowerUnits, ({ label: h, value: g, width: a, date: e }) => {
        var o;
        return E(), O("div", {
          key: e.getTime(),
          class: "g-grid-line",
...
const pe = /* @__PURE__ */ N({
  ...
  setup(t) {
    ...
    const c = I(() => {
      ...
      if (!(i != null && i.value))
        return "";
      const x = n[u.value], _ = b(C.value).format(x), d = b(f.value).format(x);
      return `${_} \u2013 ${d}`;
    });
    return (x, _) => (E(), J(Qt, { to: "body" }, [
      Bt(Zt, {
        name: "g-fade",
        mode: "out-in"
      }, {
...
wt[xt] = wt[xt] || {};
wt[xt];
var Ct = Object.getOwnPropertySymbols, _e = Object.prototype.hasOwnProperty, De = Object.prototype.propertyIsEnumerable, ke = (t, s) => {
  var n = {};
  for (var l in t)
...
function Ee(t, s = { width: 0, height: 0 }, n = {}) {
...
const Ge = {
  ...
  setup(t) {
    ...
    return (i, u) => t.labels ? (E(), O("div", Ge, [
      G("div", $e, [
        (E(!0), O(z, null, X(B(l).lowerUnits, ({ label: m, value: h, date: g, width: a }, e) => (E(), O("div", {
          key: m,
          class: "g-timeunit",
          style: L({
...
const Ae = /* @__PURE__ */ N({
  ...
  setup(t, { emit: s }) {
    ...
    }, y = $(null), x = $(null), _ = Ee(y);
    return st(Ht, g), st(At, {
      ...nt(n),
      colors: h,
      chartSize: _
    }), st(Ut, f), (d, w) => (E(), O(z, null, [
      G("div", {
      ...
      G("div", {
        ...
        G("div", {
          ...
          ref_key: "gGanttRowsContainer",
          ref: x
        }, [
          H(d.$slots, "default")
        ], 512),
        t.hideTimeaxis ? A("", !0) : (E(), J(Ie, {
          key: 2,
...
function Pe() {
  const { pushOnOverlap: t } = U(), s = zt(), n = (m) => {
    ...
    for (const g of ["left", "right"]) {
      ...
      const C = document.getElementById(m.ganttBarConfig.id);
      c != null && a === "left" ? m.ganttBarConfig.dragLimitLeft = C.offsetLeft - c : c != null && a === "right" && (m.ganttBarConfig.dragLimitRight = C.offsetLeft + C.offsetWidth + c);
    }
    ...
    if (g === "left")
      for (; o; ) {
        const c = document.getElementById(e.ganttBarConfig.id), b = document.getElementById(o.ganttBarConfig.id), C = b.offsetLeft + b.offsetWidth;
        if (h += c.offsetLeft - C, o.ganttBarConfig.immobile)
    ...
    if (g === "right")
      for (; o; ) {
        const c = document.getElementById(e.ganttBarConfig.id), b = document.getElementById(o.ganttBarConfig.id), C = c.offsetLeft + c.offsetWidth;
        if (h += b.offsetLeft - C, o.ganttBarConfig.immobile)
          return { gapDistanceSoFar: h, bundleBarsAndGapDist: a };
        o.ganttBarConfig.bundle && a.push({
          bar: o,
          gapDistance: h
    ...
    return h === "left" ? e = a.filter((o) => {
      ...
      const b = document.getElementById(o.ganttBarConfig.id), C = document.getElementById(c.ganttBarConfig.id), f = Math.abs(b.offsetLeft - g.offsetLeft), y = Math.abs(C.offsetLeft - g.offsetLeft);
      return f < y ? o : c;
    }, e[0]) : null;
  };
  return {
...
const Fe = ["id"], je = { class: "g-gantt-bar-label" }, ze = { style: { "z-index": "100" } }, Ne = /* @__PURE__ */ G("div", { class: "g-gantt-bar-handle-left" }, null, -1), Ve = /* @__PURE__ */ G("div", { class: "g-gantt-bar-handle-right" }, null, -1), qe = /* @__PURE__ */ N({
  __name: "GGanttBar",
  props: {
    bar: null
  },
  setup(t) {
    const s = t, n = Nt(), l = U(), { rowHeight: i } = l, { bar: u } = nt(s), { mapTimeToPosition: m, mapPositionToTime: h } = ft(), { initDragOfBar: g, initDragOfBundle: a } = Ue(), { setDragLimitsOfGanttBar: e } = Pe(), o = $(!1), c = I(() => u.value.ganttBarConfig);
    function b(k) {
    ...
    return Lt(() => {
      ...
      G("div", je, [
        H(k.$slots, "default", { bar: B(u) }, () => [
          G("div", ze, K(B(c).label || ""), 1),
          B(c).progress ? (E(), O("div", {
            key: 0,
...
const We = /* @__PURE__ */ N({
  ...
  setup(t, { emit: s }) {
    ...
    const e = (o) => {
      ...
      const b = o.clientX - c.left, C = g(b);
      s("drop", { e: o, datetime: C });
    };
    return (o, c) => (E(), O("div", {
      class: "g-gantt-row",
      style: L(B(h)),
      ...
      G("div", Gt({
        ...
        Bt(ae, {
          ...
          default: tt(() => [
            (E(!0), O(z, null, X(t.bars, (b) => (E(), J(qe, {
  ...
  setup(t) {
    ...
    return (i, u) => (E(), O("div", {
      ...
      G("div", Gt({
        ...
        (E(!0), O(z, null, X(B(l).lowerUnits, ({ label: m, width: h, date: g }, a) => (E(), O("div", {
          key: g.getTime(),
          class: "g-timeunit",
          style: L({
            color: B(n).text,

...
const Ye = (t, r) => {
  ...
  for (const [l, s] of r)
    n[l] = s;
  return n;
}, Ie = /* @__PURE__ */ Ye(Ge, [["__scopeId", "data-v-b1cbf765"]]), Re = { style: { display: "flex", overflow: "scroll" } }, Ae = { style: { display: "flex" } }, He = { style: { display: "flex", "flex-flow": "column" } }, Ue = /* @__PURE__ */ Y("div", {
  class: "g-timeaxis",
  style: { width: "auto" }
}, " table headers ", -1), Fe = { class: "g-gantt-rows-container" }, je = /* @__PURE__ */ V({
  __name: "GGanttChart",
  props: {
    chartStart: null,
    chartEnd: null,
...
const ze = ["id"], Ve = { class: "g-gantt-bar-label" }, qe = /* @__PURE__ */ Y("div", { class: "g-gantt-bar-handle-left" }, null, -1), We = /* @__PURE__ */ Y("div", { class: "g-gantt-bar-handle-right" }, null, -1), Ke = /* @__PURE__ */ V({
  __name: "GGanttBar",
  props: {
    bar: null
  },
  setup(t) {
    const r = t, n = Nt(), l = R(), { rowHeight: s } = l, { bar: u } = et(r), { mapTimeToPosition: c, mapPositionToTime: f } = Bt(), { initDragOfBar: d, initDragOfBundle: a } = Pe(), { setDragLimitsOfGanttBar: e } = Ne(), o = $(!1), g = I(() => u.value.ganttBarConfig);
    function w(O) {
    ...
    return (o, g) => (S(), T("div", {
      ...
      Y("div", ae({
        ...
        wt(re, {
          ...
          default: Q(() => [
            (S(!0), T(X, null, J(t.bars, (w) => (S(), Z(Ke, {
...
const en = {
  install(t, r) {
    Xe(), t.component("GGanttChart", je), t.component("GGanttRow", Qe);
  }
};
function q(t, r = "top") {

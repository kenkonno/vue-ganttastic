...
(function(t, o) {
  (function(n, l) {
    ...
    var n = { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" }, l = /(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, s = /\d\d/, u = /\d\d?/, f = /\d*[^-_:/,()\s\d]+/, g = {}, c = function(v) {
      ...
      this.milliseconds = +v;
    }], s: [u, a("seconds")], ss: [u, a("seconds")], m: [u, a("minutes")], mm: [u, a("minutes")], H: [u, a("hours")], h: [u, a("hours")], HH: [u, a("hours")], hh: [u, a("hours")], D: [u, a("day")], DD: [s, a("day")], Do: [f, function(v) {
      var b = g.ordinal, x = v.match(/\d+/);
      if (this.day = x[0], b)
        for (var m = 1; m <= 31; m += 1)
          b(m).replace(/\[|\]/g, "") === v && (this.day = m);
    }], M: [u, a("month")], MM: [s, a("month")], MMM: [f, function(v) {
...
function nt(t = A()) {
  const { chartStart: o, chartEnd: n, barStart: l, barEnd: s, dateFormat: u } = t, f = I(() => c(o.value)), g = I(() => c(n.value)), c = (e, r) => {
    let d;
  ...
  return {
    ...
    chartEndDayjs: g,
    toDayjs: c,
    format: (e, r) => r === !1 ? e instanceof Date ? e : W(e).toDate() : (typeof e == "string" || e instanceof Date ? c(e) : e).format(r)
  };
}
function dt() {
  ...
  return {
    timeaxisUnits: I(() => {
      ...
      for (; e.isBefore(n.value) || e.isSame(n.value); ) {
        if (e[c]() !== w) {
          ...
          if (f.length === 0)
            ...
            const i = e.startOf(c), p = e.subtract(1, c).startOf(c);
      ...
      return f.some((b) => b.value === String(D)) || (d += n.value.diff(
        e.subtract(1, a),
        "minutes",
        !0
      ), f.push({
        label: n.value.format(s[c]),
        value: String(w),
        date: n.value.toDate(),
        width: `${d / r * 100}%`
...
const ue = { class: "g-timeaxis" }, ce = { class: "g-timeunits-container" }, de = { class: "g-timeunits-container" }, fe = /* @__PURE__ */ N({
  ...
  setup(t) {
    ...
    return (s, u) => (C(), M("div", ue, [
      G("div", ce, [
        (C(!0), M(z, null, Z(_(l).upperUnits, ({ label: f, value: g, date: c, width: a }, e) => (C(), M("div", {
          key: c.getTime(),
      ...
      G("div", de, [
        (C(!0), M(z, null, Z(_(l).lowerUnits, ({ label: f, value: g, date: c, width: a }, e) => (C(), M("div", {
          key: c.getTime(),
          class: "g-timeunit",
          style: R({
...
const ge = { class: "g-grid-container" }, he = /* @__PURE__ */ N({
  ...
  setup(t) {
    ...
    return (u, f) => (C(), M("div", ge, [
      (C(!0), M(z, null, Z(_(s).lowerUnits, ({ label: g, value: c, width: a, date: e }) => {
        var r;
        return C(), M("div", {
          key: e.getTime(),
          class: "g-grid-line",
...
const pe = /* @__PURE__ */ N({
  ...
  setup(t) {
    const o = t, n = {
      ...
      week: "DD. MMM HH:mm",
      month: "DD. MMMM YYYY"
    }, l = "cadetblue", { bar: s } = et(o), { precision: u, font: f, barStart: g, barEnd: c, rowHeight: a } = A(), e = $("0px"), r = $("0px");
    ut(
      () => o.bar,
      async () => {
        var p;
    ...
    const d = I(() => {
      ...
      var x;
      return (x = s.value) == null ? void 0 : x[c.value];
    }), b = I(() => {
      if (!(s != null && s.value))
        return "";
...
function Oe(t, o, n = {}) {
  ...
  let f;
  const g = xe(() => s && "ResizeObserver" in s), c = () => {
    f && (f.disconnect(), f = void 0);
  }, a = ut(() => Ut(t), (r) => {
    c(), g.value && s && r && (f = new ResizeObserver(o), f.observe(r, u));
...
const Re = (t, o) => {
  ...
  setup(t, { emit: o }) {
    const n = t, { width: l, font: s, colorScheme: u } = et(n), f = ne(), g = I(
...
function Bt(t = A()) {
  const { dateFormat: o, chartSize: n } = t, { chartStartDayjs: l, chartEndDayjs: s, toDayjs: u, format: f } = nt(t), g = I(() => s.value.diff(l.value, "minutes"));
  return {
    mapTimeToPosition: (e) => {
...
function Mt(t, o = () => null, n = () => null, l = A()) {
  const { barStart: s, barEnd: u, pushOnOverlap: f } = l, g = $(!1);
  let c = 0, a;
  const { mapPositionToTime: e } = Bt(l), { toDayjs: r } = nt(l), d = (h) => {
    ...
    if (!B || !i)
      return;
    const p = B.getBoundingClientRect().width, y = h.clientX - i.left - c, E = y + p;
    if (!x(y, E)) {
...
function He() {
  const t = A(), o = zt(), n = Nt(), { pushOnOverlap: l, barStart: s, barEnd: u, noOverlap: f, dateFormat: g } = t, c = /* @__PURE__ */ new Map(), { toDayjs: a, format: e } = nt(), r = (i, p) => {
    ...
    c.forEach((p, y) => {
      ...
      E != null && (i = !0);
    }), i && c.forEach(({ oldStart: p, oldEnd: y }, E) => {
...
function Fe() {
  const { pushOnOverlap: t } = A(), o = zt(), n = (f) => {
    const g = [];
    ...
    for (const c of ["left", "right"]) {
      const a = c, { gapDistanceSoFar: e, bundleBarsAndGapDist: r } = s(
        f,
        0,
        a
      );
      ...
      d != null && a === "left" ? f.ganttBarConfig.dragLimitLeft = D.offsetLeft - d : d != null && a === "right" && (f.ganttBarConfig.dragLimitRight = D.offsetLeft + D.offsetWidth + d);
    }
    ...
    return g === "left" ? e = a.filter((r) => {
      ...
      const w = document.getElementById(r.ganttBarConfig.id), D = document.getElementById(d.ganttBarConfig.id), v = Math.abs(w.offsetLeft - c.offsetLeft), b = Math.abs(D.offsetLeft - c.offsetLeft);
      return v < b ? r : d;
    }, e[0]) : null;
  };
  return {
...
const je = ["id"], Pe = { class: "g-gantt-bar-label" }, Ue = { style: { "z-index": "100" } }, ze = /* @__PURE__ */ G("div", { class: "g-gantt-bar-handle-left" }, null, -1), Ne = /* @__PURE__ */ G("div", { class: "g-gantt-bar-handle-right" }, null, -1), Ve = /* @__PURE__ */ N({
  ...
  setup(t) {
    const o = t, n = Nt(), l = A(), { rowHeight: s } = l, { bar: u } = et(o), { mapTimeToPosition: f, mapPositionToTime: g } = Bt(), { initDragOfBar: c, initDragOfBundle: a } = He(), { setDragLimitsOfGanttBar: e } = Fe(), r = $(!1), d = I(() => u.value.ganttBarConfig);
    function w(O) {
      d.value.bundle != null ? a(u.value, O) : c(u.value, O), r.value = !0;
    }
    const D = () => {
...
const qe = /* @__PURE__ */ N({
  ...
  emits: ["drop"],
  setup(t, { emit: o }) {
    const n = t, { rowHeight: l, colors: s } = A(), { highlightOnHover: u } = et(n), f = $(!1), g = I(() => ({
      height: `${l.value}px`,
      background: (u == null ? void 0 : u.value) && f.value ? s.value.hoverHighlight : null
    ...
    const e = (r) => {
      ...
      const w = r.clientX - d.left, D = c(w);
  ...
  setup(t) {
    ...
    return (s, u) => (C(), M("div", {
      ...
      G("div", Gt({
        ...
        (C(!0), M(z, null, Z(_(l).lowerUnits, ({ label: f, width: g, date: c }, a) => (C(), M("div", {
          key: c.getTime(),
          class: "g-timeunit",
          style: R({
            color: _(n).text,
          ...
          G("span", {
            style: R(t.styles != null ? t.styles[a] : void 0)
          }, J(t.labels[a]), 5)
        ], 4))), 128))
      ], 16)
    ], 4));

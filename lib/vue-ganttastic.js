...
(function(t, o) {
  (function(n, l) {
    ...
    return function(n, l, s) {
      l.prototype.isBetween = function(u, c, f, g) {
        var a = s(u), e = s(c), r = (g = g || "()")[0] === "(", d = g[1] === ")";
        return (r ? this.isAfter(a, f) : !this.isBefore(a, f)) && (d ? this.isBefore(e, f) : !this.isAfter(e, f)) || (r ? this.isBefore(a, f) : !this.isAfter(a, f)) && (d ? this.isAfter(e, f) : !this.isBefore(e, f));
      };
    };
  });
})(Yt);
...
(function(t, o) {
  (function(n, l) {
    ...
    var n = { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" }, l = /(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, s = /\d\d/, u = /\d\d?/, c = /\d*[^-_:/,()\s\d]+/, f = {}, g = function(v) {
    ...
    function D(v) {
      ...
      for (var m = (v = b.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, function(O, k, M) {
        ...
        return k || x[M] || n[M] || x[S].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, function(L, Y, F) {
          return Y || F.slice(1);
        });
    ...
    return function(v, b, x) {
      ...
      m.parse = function(B) {
        ...
        var E = y[1];
        if (typeof E == "string") {
          var O = y[2] === !0, k = y[3] === !0, M = O || k, S = y[2];
          k && (S = y[2]), f = this.$locale(), !O && S && (f = x.Ls[S]), this.$d = function(U, K, q) {
            try {
              if (["x", "X"].indexOf(K) > -1)
          ...
          }(i, E, p), this.init(), S && S !== !0 && (this.$L = this.locale(S).$L), M && i != this.format(E) && (this.$d = new Date("")), f = {};
...
function nt(t = A()) {
  const { chartStart: o, chartEnd: n, barStart: l, barEnd: s, dateFormat: u } = t, c = I(() => g(o.value)), f = I(() => g(n.value)), g = (e, r) => {
    let d;
  ...
  return {
    ...
    chartEndDayjs: f,
    toDayjs: g,
    format: (e, r) => r === !1 ? e instanceof Date ? e : W(e).toDate() : (typeof e == "string" || e instanceof Date ? g(e) : e).format(r)
  };
}
function dt() {
  ...
  return {
    timeaxisUnits: I(() => {
      const c = [], f = [], g = l.value === "day" ? "date" : l.value, a = t.value;
      ...
      for (; e.isBefore(n.value) || e.isSame(n.value); ) {
        if (e[g]() !== w) {
          let h = 0;
          if (c.length === 0)
            h = e.startOf(g).diff(o.value, "minutes", !0) / r * 100;
        ...
        let b = 0;
        f.length === 0 ? b = e.endOf(a).diff(o.value, "minutes", !0) / r * 100 : e.add(1, a).isSameOrAfter(n.value) ? b = n.value.diff(e.startOf(a), "minutes", !0) / r * 100 : b = e.endOf(a).diff(e.startOf(a), "minutes", !0) / r * 100;
        let x;
        switch (a) {
          case "week":
            x = e.startOf("week");
...
const ue = { class: "g-timeaxis" }, ce = { class: "g-timeunits-container" }, de = { class: "g-timeunits-container" }, fe = /* @__PURE__ */ N({
  ...
  setup(t) {
    ...
    return (s, u) => (C(), T("div", ue, [
      G("div", ce, [
        (C(!0), T(z, null, Z(_(l).upperUnits, ({ label: c, value: f, date: g, width: a }, e) => (C(), T("div", {
          key: c,
      ...
      G("div", de, [
        (C(!0), T(z, null, Z(_(l).lowerUnits, ({ label: c, value: f, date: g, width: a }, e) => (C(), T("div", {
          key: c,
          class: "g-timeunit",
          style: R({
...
const ge = { class: "g-grid-container" }, he = /* @__PURE__ */ N({
  ...
  setup(t) {
    ...
    return (u, c) => (C(), T("div", ge, [
      (C(!0), T(z, null, Z(_(s).lowerUnits, ({ label: f, value: g, width: a, date: e }) => {
        var r;
        return C(), T("div", {
          key: f,
          class: "g-grid-line",
...
const pe = /* @__PURE__ */ N({
  ...
  setup(t) {
    const o = t, n = {
      ...
      week: "DD. MMM HH:mm",
      month: "DD. MMMM YYYY"
    }, l = "cadetblue", { bar: s } = et(o), { precision: u, font: c, barStart: f, barEnd: g, rowHeight: a } = A(), e = $("0px"), r = $("0px");
    ut(
      () => o.bar,
      async () => {
        var p;
...
function Oe(t, o, n = {}) {
  ...
  const f = xe(() => s && "ResizeObserver" in s), g = () => {
    ...
    g(), f.value && s && r && (c = new ResizeObserver(o), c.observe(r, u));
...
var Ce = Object.defineProperty, kt = Object.getOwnPropertySymbols, ke = Object.prototype.hasOwnProperty, Me = Object.prototype.propertyIsEnumerable, Mt = (t, o, n) => o in t ? Ce(t, o, { enumerable: !0, configurable: !0, writable: !0, value: n }) : t[o] = n, Te = (t, o) => {
  for (var n in o || (o = {}))
    ke.call(o, n) && Mt(t, n, o[n]);
  if (kt)
    for (var n of kt(o))
      Me.call(o, n) && Mt(t, n, o[n]);
  return t;
};
const Se = {
...
const Le = {
  ...
  setup(t) {
    const { precision: o, colors: n } = A(), { timeaxisUnits: l } = dt();
    return (s, u) => t.labels ? (C(), T("div", Le, [
      G("div", Ge, [
        (C(!0), T(z, null, Z(_(l).lowerUnits, ({ label: c, value: f, date: g, width: a }, e) => (C(), T("div", {
          key: c,
          class: "g-timeunit",
...
const Re = (t, o) => {
  ...
  setup(t, { emit: o }) {
    const n = t, { width: l, font: s, colorScheme: u } = et(n), c = ne(), f = I(
...
function Bt(t = A()) {
  const { dateFormat: o, chartSize: n } = t, { chartStartDayjs: l, chartEndDayjs: s, toDayjs: u, format: c } = nt(t), f = I(() => s.value.diff(l.value, "minutes"));
  return {
    mapTimeToPosition: (e) => {
      const r = n.width.value || 0, d = u(e).diff(l.value, "minutes", !0);
      return Math.ceil(d / f.value * r);
    },
    mapPositionToTime: (e) => {
      const r = n.width.value || 0, d = e / r * f.value, w = c(l.value.add(d, "minutes"), o.value);
      if (typeof w == "string")
        return w;
      throw Error;
    }
...
function Tt(t, o = () => null, n = () => null, l = A()) {
  ...
  const { mapPositionToTime: e } = Bt(l), { toDayjs: r } = nt(l), d = (h) => {
    ...
    if (!x(y, E)) {
      if (t[s.value].substring(0, 10) != e(y).substring(0, 10)) {
        const O = r(t[s.value]), M = r(t[u.value]).diff(O, "minute"), S = e(y).substring(0, 10) + " 00:00";
        t[s.value] = S, t[u.value] = r(S).add(M, "minute").format("DD.MM.YYYY HH:mm");
      }
      o(h, t);
    }
  }, v = (h) => {
...
function He() {
  const t = A(), o = zt(), n = Nt(), { pushOnOverlap: l, barStart: s, barEnd: u, noOverlap: c, dateFormat: f } = t, g = /* @__PURE__ */ new Map(), { toDayjs: a, format: e } = nt(), r = (i, p) => {
    const { initDrag: y } = Tt(i, w, m, t);
    ...
    y != null && (o().forEach((E) => {
      E.forEach((O) => {
        if (O.ganttBarConfig.bundle === y) {
          const k = O === i ? m : () => null, { initDrag: M } = Tt(O, w, k, t);
          M(p), h(O);
        }
      });
    ...
    for (; y; ) {
      h(y);
      const O = a(p[s.value]), k = a(p[u.value]), M = a(y[s.value]), S = a(y[u.value]);
      let L;
      switch (E) {
        case "left":
          L = S.diff(O, "minutes", !0), y[u.value] = e(p[s.value], f.value), y[s.value] = e(
            M.subtract(L, "minutes"),
            f.value
          );
          break;
        case "right":
          L = k.diff(M, "minutes", !0), y[s.value] = e(k, f.value), y[u.value] = e(
            S.add(L, "minutes"),
            f.value
          );
          break;
    ...
    let p, y, E;
    const O = o().find((Y) => Y.includes(i)) || [], k = a(i[s.value]), M = a(i[u.value]);
    ...
    switch (y) {
      ...
      case "right":
        i[s.value] = e(
          ...
          f.value
        ), i[u.value] = e(a(i, "end").add(p, "minutes"), f.value);
    }
    D(i);
  }, m = (i, p) => {
    B();
...
function Fe() {
  const { pushOnOverlap: t } = A(), o = zt(), n = (c) => {
    ...
    for (const g of ["left", "right"]) {
      const a = g, { gapDistanceSoFar: e, bundleBarsAndGapDist: r } = s(
        c,
        0,
        a
      );
    ...
    n(c.ganttBarConfig.bundle).forEach((g) => {
      g.ganttBarConfig.dragLimitLeft = c.ganttBarConfig.dragLimitLeft, g.ganttBarConfig.dragLimitRight = c.ganttBarConfig.dragLimitRight;
    });
  }, s = (c, f = 0, g) => {
    ...
    if (g === "left")
      for (; r; ) {
        ...
        if (f += d.offsetLeft - D, r.ganttBarConfig.immobile)
    ...
    if (g === "right")
      for (; r; ) {
        ...
        if (f += w.offsetLeft - D, r.ganttBarConfig.immobile)
          return { gapDistanceSoFar: f, bundleBarsAndGapDist: a };
        r.ganttBarConfig.bundle && a.push({
          bar: r,
          gapDistance: f
    ...
    const g = document.getElementById(c.ganttBarConfig.id), a = o().find((r) => r.includes(c)) || [];
    let e = [];
    return f === "left" ? e = a.filter((r) => {
      const d = document.getElementById(r.ganttBarConfig.id);
      return d && d.offsetLeft < g.offsetLeft && r.ganttBarConfig.pushOnOverlap !== !1;
    }) : e = a.filter((r) => {
      const d = document.getElementById(r.ganttBarConfig.id);
      return d && d.offsetLeft > g.offsetLeft && r.ganttBarConfig.pushOnOverlap !== !1;
    }), e.length > 0 ? e.reduce((r, d) => {
      const w = document.getElementById(r.ganttBarConfig.id), D = document.getElementById(d.ganttBarConfig.id), v = Math.abs(w.offsetLeft - g.offsetLeft), b = Math.abs(D.offsetLeft - g.offsetLeft);
      return v < b ? r : d;
    }, e[0]) : null;
  };
  return {
...
const je = ["id"], Pe = { class: "g-gantt-bar-label" }, Ue = { style: { "z-index": "100" } }, ze = /* @__PURE__ */ G("div", { class: "g-gantt-bar-handle-left" }, null, -1), Ne = /* @__PURE__ */ G("div", { class: "g-gantt-bar-handle-right" }, null, -1), Ve = /* @__PURE__ */ N({
  ...
  setup(t) {
    const o = t, n = Nt(), l = A(), { rowHeight: s } = l, { bar: u } = et(o), { mapTimeToPosition: c, mapPositionToTime: f } = Bt(), { initDragOfBar: g, initDragOfBundle: a } = He(), { setDragLimitsOfGanttBar: e } = Fe(), r = $(!1), d = I(() => u.value.ganttBarConfig);
    function w(O) {
      d.value.bundle != null ? a(u.value, O) : g(u.value, O), r.value = !0;
    }
    const D = () => {
...
const qe = /* @__PURE__ */ N({
  ...
  emits: ["drop"],
  setup(t, { emit: o }) {
    const n = t, { rowHeight: l, colors: s } = A(), { highlightOnHover: u } = et(n), c = $(!1), f = I(() => ({
      height: `${l.value}px`,
    ...
    const e = (r) => {
      ...
      const w = r.clientX - d.left, D = g(w);
  ...
  setup(t) {
    ...
    return (s, u) => (C(), T("div", {
      ...
      G("div", Gt({
        ...
        (C(!0), T(z, null, Z(_(l).lowerUnits, ({ label: c, width: f }, g) => (C(), T("div", {
          key: c,
          class: "g-timeunit",
          style: R({
            color: _(n).text,
          ...
          G("span", {
            style: R(t.styles != null ? t.styles[g] : void 0)
          }, J(t.labels[g]), 5)
        ], 4))), 128))
      ], 16)
    ], 4));

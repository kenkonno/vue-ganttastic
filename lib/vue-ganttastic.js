import z from "dayjs";
import { inject as lt, computed as R, defineComponent as V, openBlock as S, createElementBlock as T, createElementVNode as Y, Fragment as X, renderList as J, unref as E, normalizeStyle as F, renderSlot as I, createTextVNode as st, toDisplayString as tt, createCommentVNode as P, toRefs as et, ref as $, watch as ut, nextTick as Tt, createBlock as Z, Teleport as Qt, createVNode as wt, Transition as Xt, withCtx as Q, getCurrentScope as Zt, onScopeDispose as Jt, getCurrentInstance as te, onMounted as Lt, useSlots as ee, provide as it, withModifiers as ne, mergeProps as ae, TransitionGroup as re } from "vue";
  ...
  (function(n, l) {
    ...
    function D(v) {
      ...
      for (var h = (v = b.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, function(O, C, k) {
        ...
        return C || x[k] || n[k] || x[M].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, function(L, G, H) {
          return G || H.slice(1);
        });
      ...
      return function(O) {
        for (var C = {}, k = 0, M = 0; k < p; k += 1) {
          ...
          if (typeof L == "string")
            ...
            var G = L.regex, H = L.parser, j = O.slice(M), W = G.exec(j)[0];
        ...
        return function(N) {
          ...
          if (U !== void 0) {
            var K = N.hours;
            U ? K < 12 && (N.hours += 12) : K === 12 && (N.hours = 0), delete N.afternoon;
          }
        }(C), C;
      };
    }
        ...
        if (typeof _ == "string") {
          ...
          C && (M = y[2]), f = this.$locale(), !O && M && (f = x.Ls[M]), this.$d = function(j, W, N) {
            try {
              ...
              var U = D(W)(j), K = U.year, rt = U.month, zt = U.day, Vt = U.hours, qt = U.minutes, Wt = U.seconds, Kt = U.milliseconds, _t = U.zone, dt = new Date(), ft = zt || (K || rt ? 1 : dt.getDate()), gt = K || dt.getFullYear(), ot = 0;
...
function nt(t = A()) {
  const { chartStart: r, chartEnd: n, barStart: l, barEnd: s, dateFormat: u } = t, c = R(() => d(r.value)), f = R(() => d(n.value)), d = (e, o) => {
    let g;
...
function xt() {
  const { precision: t } = A(), { chartStartDayjs: r, chartEndDayjs: n } = nt(), l = R(() => {
...
const ue = { class: "g-timeaxis" }, ce = { class: "g-timeunits-container" }, de = { class: "g-timeunits-container" }, fe = /* @__PURE__ */ V({
  ...
  setup(t) {
    const { precision: r, colors: n } = A(), { timeaxisUnits: l } = xt();
...
const ge = { class: "g-grid-container" }, he = /* @__PURE__ */ V({
  ...
  setup(t) {
    const { colors: r } = A(), { timeaxisUnits: n } = xt();
...
const pe = /* @__PURE__ */ V({
  ...
  setup(t) {
    const r = t, n = {
      ...
      day: "DD. MMM HH:mm",
      month: "DD. MMMM YYYY"
    }, l = "cadetblue", { bar: s } = et(r), { precision: u, font: c, barStart: f, barEnd: d, rowHeight: a } = A(), e = $("0px"), o = $("0px");
    ut(
      () => r.bar,
      async () => {
        var m;
...
const Ye = (t, r) => {
  ...
  for (const [l, s] of r)
    n[l] = s;
  return n;
}, Ie = /* @__PURE__ */ Ye(Ge, [["__scopeId", "data-v-b1cbf765"]]), Re = { style: { display: "flex", overflow: "scroll" } }, Ae = { style: { display: "flex" } }, He = {
  class: "g-timeaxis",
  style: { width: "auto" }
}, Ue = { class: "g-gantt-rows-container" }, Fe = /* @__PURE__ */ V({
  __name: "GGanttChart",
  props: {
    chartStart: null,
    chartEnd: null,
  ...
  setup(t, { emit: r }) {
    const n = t, { width: l, font: s, colorScheme: u } = et(n), c = ee(), f = R(
      ...
      Y("div", Ae, [
        ...
        Y("div", {
          ...
          wt(pe, {
            ...
            default: Q(() => [
              I(h.$slots, "bar-tooltip", { bar: o.value })
            ]),
            _: 3
          }, 8, ["model-value", "bar"])
        ], 4)
...
function Bt(t = A()) {
  const { dateFormat: r, chartSize: n } = t, { chartStartDayjs: l, chartEndDayjs: s, toDayjs: u, format: c } = nt(t), f = R(() => s.value.diff(l.value, "minutes"));
  return {
    mapTimeToPosition: (e) => {
...
function je() {
  const t = A(), r = Pt(), n = Nt(), { pushOnOverlap: l, barStart: s, barEnd: u, noOverlap: c, dateFormat: f } = t, d = /* @__PURE__ */ new Map(), { toDayjs: a, format: e } = nt(), o = (i, m) => {
    ...
    return { overlapBar: O.find((G) => {
      if (G === i)
        return !1;
      const H = a(G[s.value]), j = a(G[u.value]);
      return m = C.isBetween(H, j), y = k.isBetween(H, j), _ = H.isBetween(C, k) || j.isBetween(C, k), m || y || _;
...
function Pe() {
  const { pushOnOverlap: t } = A(), r = Pt(), n = (c) => {
    const f = [];
...
const Ne = ["id"], ze = { class: "g-gantt-bar-label" }, Ve = /* @__PURE__ */ Y("div", { class: "g-gantt-bar-handle-left" }, null, -1), qe = /* @__PURE__ */ Y("div", { class: "g-gantt-bar-handle-right" }, null, -1), We = /* @__PURE__ */ V({
  __name: "GGanttBar",
  props: {
    bar: null
  },
  setup(t) {
    const r = t, n = Nt(), l = A(), { rowHeight: s } = l, { bar: u } = et(r), { mapTimeToPosition: c, mapPositionToTime: f } = Bt(), { initDragOfBar: d, initDragOfBundle: a } = je(), { setDragLimitsOfGanttBar: e } = Pe(), o = $(!1), g = R(() => u.value.ganttBarConfig);
    function w(O) {
...
const Ke = /* @__PURE__ */ V({
  ...
  emits: ["drop"],
  setup(t, { emit: r }) {
    const n = t, { rowHeight: l, colors: s } = A(), { highlightOnHover: u } = et(n), c = $(!1), f = R(() => ({
      height: `${l.value}px`,
    ...
    return (o, g) => (S(), T("div", {
      ...
      Y("div", ae({
        ...
        wt(re, {
          ...
          default: Q(() => [
            (S(!0), T(X, null, J(t.bars, (w) => (S(), Z(We, {
              key: w.ganttBarConfig.id,
              bar: w
            }, {
              default: Q(() => [
                I(o.$slots, "bar-label", { bar: w })
              ]),
              _: 2
            }, 1032, ["bar"]))), 128))
          ]),

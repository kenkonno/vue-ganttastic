import N from "dayjs";
import { inject as lt, computed as I, defineComponent as V, openBlock as k, createElementBlock as M, createElementVNode as Y, Fragment as X, renderList as J, unref as E, normalizeStyle as R, renderSlot as j, createTextVNode as st, toDisplayString as tt, createCommentVNode as P, toRefs as et, ref as $, watch as ut, nextTick as Mt, createBlock as Z, Teleport as Qt, createVNode as wt, Transition as Xt, withCtx as Q, getCurrentScope as Zt, onScopeDispose as Jt, getCurrentInstance as te, onMounted as Lt, useSlots as ee, provide as it, withModifiers as ne, mergeProps as ae, TransitionGroup as re } from "vue";
  ...
  (function(n, u) {
    ...
    function D(v) {
      ...
      for (var h = (v = b.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, function(O, C, T) {
        ...
        return C || x[T] || n[T] || x[S].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, function(L, G, H) {
          return G || H.slice(1);
        });
      ...
      return function(O) {
        for (var C = {}, T = 0, S = 0; T < p; T += 1) {
          ...
          if (typeof L == "string")
            ...
            var G = L.regex, H = L.parser, U = O.slice(S), W = G.exec(U)[0];
        ...
        return function(z) {
          ...
          if (F !== void 0) {
            var K = z.hours;
            F ? K < 12 && (z.hours += 12) : K === 12 && (z.hours = 0), delete z.afternoon;
          }
        }(C), C;
      };
    }
    return function(v, b, x) {
      ...
      h.parse = function(B) {
        ...
        if (typeof _ == "string") {
          ...
          C && (S = y[2]), g = this.$locale(), !O && S && (g = x.Ls[S]), this.$d = function(U, W, z) {
            try {
              if (["x", "X"].indexOf(W) > -1)
                return new Date((W === "X" ? 1e3 : 1) * U);
              var F = D(W)(U), K = F.year, rt = F.month, Nt = F.day, Vt = F.hours, qt = F.minutes, Wt = F.seconds, Kt = F.milliseconds, _t = F.zone, dt = new Date(), ft = Nt || (K || rt ? 1 : dt.getDate()), gt = K || dt.getFullYear(), ot = 0;
...
function nt(t = A()) {
  const { chartStart: o, chartEnd: n, barStart: u, barEnd: s, dateFormat: c } = t, d = I(() => f(o.value)), g = I(() => f(n.value)), f = (e, r) => {
    let l;
...
function xt() {
  const { precision: t } = A(), { chartStartDayjs: o, chartEndDayjs: n } = nt(), u = I(() => {
...
const ue = { class: "g-timeaxis" }, ce = { class: "g-timeunits-container" }, de = { class: "g-timeunits-container" }, fe = /* @__PURE__ */ V({
  ...
  setup(t) {
    const { precision: o, colors: n } = A(), { timeaxisUnits: u } = xt();
    return (s, c) => (k(), M("div", ue, [
      Y("div", ce, [
        (k(!0), M(X, null, J(E(u).upperUnits, ({ label: d, value: g, date: f, width: a }, e) => (k(), M("div", {
          key: d,
      ...
      Y("div", de, [
        (k(!0), M(X, null, J(E(u).lowerUnits, ({ label: d, value: g, date: f, width: a }, e) => (k(), M("div", {
          key: d,
          class: "g-timeunit",
          style: R({
...
const ge = { class: "g-grid-container" }, he = /* @__PURE__ */ V({
  ...
  setup(t) {
    var c;
    const n = (c = t.highlightedDates) == null ? void 0 : c.map((d) => d.getTime()), { colors: u } = A(), { timeaxisUnits: s } = xt();
    return (d, g) => (k(), M("div", ge, [
      (k(!0), M(X, null, J(E(s).lowerUnits, ({ label: f, value: a, width: e, date: r }) => {
        var l;
        return k(), M("div", {
          key: f,
          class: "g-grid-line",
...
const pe = /* @__PURE__ */ V({
  ...
  setup(t) {
    const o = t, n = {
      ...
      day: "DD. MMM HH:mm",
      month: "DD. MMMM YYYY"
    }, u = "cadetblue", { bar: s } = et(o), { precision: c, font: d, barStart: g, barEnd: f, rowHeight: a } = A(), e = $("0px"), r = $("0px");
    ut(
      () => o.bar,
      async () => {
        var m;
...
const Ye = (t, o) => {
  ...
  for (const [u, s] of o)
    n[u] = s;
  return n;
}, Ie = /* @__PURE__ */ Ye(Ge, [["__scopeId", "data-v-b1cbf765"]]), Re = { style: { display: "flex", overflow: "scroll" } }, Ae = { style: { display: "flex" } }, He = { class: "g-gantt-rows-container" }, Fe = /* @__PURE__ */ V({
  __name: "GGanttChart",
  props: {
    chartStart: null,
    chartEnd: null,
      ...
      Y("div", Ae, [
        ...
        Y("div", {
          ...
          wt(pe, {
            ...
            default: Q(() => [
              j(h.$slots, "bar-tooltip", { bar: r.value })
            ]),
            _: 3
          }, 8, ["model-value", "bar"])
        ], 4)
...
function Bt(t = A()) {
  const { dateFormat: o, chartSize: n } = t, { chartStartDayjs: u, chartEndDayjs: s, toDayjs: c, format: d } = nt(t), g = I(() => s.value.diff(u.value, "minutes"));
  return {
    mapTimeToPosition: (e) => {
...
function St(t, o = () => null, n = () => null, u = A()) {
...
function je() {
  const t = A(), o = Ut(), n = zt(), { pushOnOverlap: u, barStart: s, barEnd: c, noOverlap: d, dateFormat: g } = t, f = /* @__PURE__ */ new Map(), { toDayjs: a, format: e } = nt(), r = (i, m) => {
    ...
    return { overlapBar: O.find((G) => {
      if (G === i)
        return !1;
      const H = a(G[s.value]), U = a(G[c.value]);
      return m = C.isBetween(H, U), y = T.isBetween(H, U), _ = H.isBetween(C, T) || U.isBetween(C, T), m || y || _;
...
function Pe() {
  const { pushOnOverlap: t } = A(), o = Ut(), n = (d) => {
    const g = [];
...
const Ue = ["id"], ze = { class: "g-gantt-bar-label" }, Ne = { style: { "z-index": "100" } }, Ve = /* @__PURE__ */ Y("div", { class: "g-gantt-bar-handle-left" }, null, -1), qe = /* @__PURE__ */ Y("div", { class: "g-gantt-bar-handle-right" }, null, -1), We = /* @__PURE__ */ V({
  __name: "GGanttBar",
  props: {
    bar: null
  },
  setup(t) {
    const o = t, n = zt(), u = A(), { rowHeight: s } = u, { bar: c } = et(o), { mapTimeToPosition: d, mapPositionToTime: g } = Bt(), { initDragOfBar: f, initDragOfBundle: a } = je(), { setDragLimitsOfGanttBar: e } = Pe(), r = $(!1), l = I(() => c.value.ganttBarConfig);
    function w(O) {
    ...
    return Lt(() => {
      ...
      Y("div", ze, [
        j(O.$slots, "default", { bar: E(c) }, () => [
          Y("div", Ne, tt(E(l).label || ""), 1),
    ...
    return (r, l) => (k(), M("div", {
      ...
      Y("div", ae({
        ...
        wt(re, {
          ...
          default: Q(() => [
            (k(!0), M(X, null, J(t.bars, (w) => (k(), Z(We, {
              key: w.ganttBarConfig.id,
              bar: w
            }, {
              default: Q(() => [
                j(r.$slots, "bar-label", { bar: w })
              ]),
              _: 2
            }, 1032, ["bar"]))), 128))
          ]),
...
const tn = {
  install(t, o) {
    Qe(), t.component("GGanttChart", Fe), t.component("GGanttRow", Ke);
  }
};
function q(t, o = "top") {

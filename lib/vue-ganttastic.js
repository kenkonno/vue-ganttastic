...
(function(t, r) {
  (function(n, l) {
    ...
    return function(n, l, s) {
      l.prototype.isBetween = function(c, u, g, f) {
        var a = s(c), e = s(u), o = (f = f || "()")[0] === "(", d = f[1] === ")";
...
(function(t, r) {
  (function(n, l) {
    ...
    var n = { LTS: "h:mm:ss A", LT: "h:mm A", L: "MM/DD/YYYY", LL: "MMMM D, YYYY", LLL: "MMMM D, YYYY h:mm A", LLLL: "dddd, MMMM D, YYYY h:mm A" }, l = /(\[[^[]*\])|([-_:/.,()\s]+)|(A|a|YYYY|YY?|MM?M?M?|Do|DD?|hh?|HH?|mm?|ss?|S{1,3}|z|ZZ?)/g, s = /\d\d/, c = /\d\d?/, u = /\d*[^-_:/,()\s\d]+/, g = {}, f = function(v) {
...
function nt(t = A()) {
  const { chartStart: r, chartEnd: n, barStart: l, barEnd: s, dateFormat: c } = t, u = I(() => f(r.value)), g = I(() => f(n.value)), f = (e, o) => {
    let d;
...
const ge = { class: "g-grid-container" }, he = /* @__PURE__ */ N({
  ...
  setup(t) {
    ...
    return (c, u) => (C(), S("div", ge, [
      (C(!0), S(z, null, Z(_(s).lowerUnits, ({ label: g, value: f, width: a, date: e }) => {
        var o;
        return C(), S("div", {
          key: g,
          class: "g-grid-line",
...
const pe = /* @__PURE__ */ N({
  ...
  setup(t) {
    const r = t, n = {
      ...
      week: "DD. MMM HH:mm",
      month: "DD. MMMM YYYY"
    }, l = "cadetblue", { bar: s } = et(r), { precision: c, font: u, barStart: g, barEnd: f, rowHeight: a } = A(), e = $("0px"), o = $("0px");
    ut(
      () => r.bar,
      async () => {
        var p;
...
function Oe(t, r, n = {}) {
  ...
  const g = xe(() => s && "ResizeObserver" in s), f = () => {
    ...
    f(), g.value && s && o && (u = new ResizeObserver(r), u.observe(o, c));
...
const Re = (t, r) => {
  ...
  setup(t, { emit: r }) {
    const n = t, { width: l, font: s, colorScheme: c } = et(n), u = ne(), g = I(
...
function Bt(t = A()) {
  const { dateFormat: r, chartSize: n } = t, { chartStartDayjs: l, chartEndDayjs: s, toDayjs: c, format: u } = nt(t), g = I(() => s.value.diff(l.value, "minutes"));
  return {
    mapTimeToPosition: (e) => {
    ...
    mapPositionToTime: (e) => {
      const o = n.width.value || 0, d = e / o * g.value, w = u(l.value.add(d, "minutes"), r.value);
      if (typeof w == "string")
        return w;
      throw Error;
    }
...
function St(t, r = () => null, n = () => null, l = A()) {
  const { barStart: s, barEnd: c, pushOnOverlap: u } = l, g = $(!1);
  let f = 0, a;
...
function He() {
  const t = A(), r = zt(), n = Nt(), { pushOnOverlap: l, barStart: s, barEnd: c, noOverlap: u, dateFormat: g } = t, f = /* @__PURE__ */ new Map(), { toDayjs: a, format: e } = nt(), o = (i, p) => {
    ...
    for (; y; ) {
      ...
      switch (E) {
        case "left":
          L = T.diff(O, "minutes", !0), y[c.value] = e(p[s.value], g.value), y[s.value] = e(
            M.subtract(L, "minutes"),
            g.value
          );
          break;
        case "right":
          L = k.diff(M, "minutes", !0), y[s.value] = e(k, g.value), y[c.value] = e(
            T.add(L, "minutes"),
            g.value
          );
          break;
    ...
    switch (y) {
      ...
      case "right":
        i[s.value] = e(
          ...
          g.value
        ), i[c.value] = e(a(i, "end").add(p, "minutes"), g.value);
    }
    D(i);
  }, m = (i, p) => {
    B();
  ...
  const { pushOnOverlap: t } = A(), r = zt(), n = (u) => {
    ...
    if (f === "left")
      for (; o; ) {
        ...
        if (g += d.offsetLeft - D, o.ganttBarConfig.immobile)
    ...
    return g === "left" ? e = a.filter((o) => {
      ...
      return d && d.offsetLeft < f.offsetLeft && o.ganttBarConfig.pushOnOverlap !== !1;
    }) : e = a.filter((o) => {
      const d = document.getElementById(o.ganttBarConfig.id);
      return d && d.offsetLeft > f.offsetLeft && o.ganttBarConfig.pushOnOverlap !== !1;
    }), e.length > 0 ? e.reduce((o, d) => {
      const w = document.getElementById(o.ganttBarConfig.id), D = document.getElementById(d.ganttBarConfig.id), v = Math.abs(w.offsetLeft - f.offsetLeft), b = Math.abs(D.offsetLeft - f.offsetLeft);
      return v < b ? o : d;
    }, e[0]) : null;
  };
  return {
...
const je = ["id"], Pe = { class: "g-gantt-bar-label" }, Ue = { style: { "z-index": "100" } }, ze = /* @__PURE__ */ G("div", { class: "g-gantt-bar-handle-left" }, null, -1), Ne = /* @__PURE__ */ G("div", { class: "g-gantt-bar-handle-right" }, null, -1), Ve = /* @__PURE__ */ N({
  ...
  setup(t) {
    const r = t, n = Nt(), l = A(), { rowHeight: s } = l, { bar: c } = et(r), { mapTimeToPosition: u, mapPositionToTime: g } = Bt(), { initDragOfBar: f, initDragOfBundle: a } = He(), { setDragLimitsOfGanttBar: e } = Fe(), o = $(!1), d = I(() => c.value.ganttBarConfig);
    function w(O) {
      d.value.bundle != null ? a(c.value, O) : f(c.value, O), o.value = !0;
    }
    const D = () => {
...
const qe = /* @__PURE__ */ N({
  ...
  emits: ["drop"],
  setup(t, { emit: r }) {
    const n = t, { rowHeight: l, colors: s } = A(), { highlightOnHover: c } = et(n), u = $(!1), g = I(() => ({
      height: `${l.value}px`,
    ...
    const e = (o) => {
      ...
      const w = o.clientX - d.left, D = f(w);
